...
GENERAL_TRAIN = S_GENERAL_DIR / "master_development.csv"

GENERAL_TEST = S_GENERAL_DIR / "master_test.csv"

CONTENT_RATING_TRAIN = S_CONTENT_RATING_DIR / "content_rating_development.csv"

CONTENT_RATING_TEST = S_CONTENT_RATING_DIR / "content_rating_test.csv"

BOX_OFFICE_TRAIN = S_BOX_OFFICE_SPLIT_DIR / "box_office_development.csv"

BOX_OFFICE_TEST = S_BOX_OFFICE_SPLIT_DIR / "box_office_test.csv"


# FEATURE OUTPUT FILES

GENERAL_TRAIN_FEATURES = GENERAL_DIR / "master_training.csv"

GENERAL_TEST_FEATURES = GENERAL_DIR / "master_test.csv"

CONTENT_RATING_TRAIN_FEATURES = CONTENT_RATING_DIR / "content_rating_training.csv"

CONTENT_RATING_TEST_FEATURES = CONTENT_RATING_DIR / "content_rating_test.csv"

BOX_OFFICE_TRAIN_FEATURES = BOX_OFFICE_DIR / "box_office_training.csv"

BOX_OFFICE_TEST_FEATURES = BOX_OFFICE_DIR / "box_office_test.csv"
...
def featurize_dataset(
    ...
    target_columnns = [*genre_target_columns, *BASE_TARGET_COLUMNS]

    # Select only the raw tabular features

    training_input = training[FEATURE_COLUMNS].copy()

    test_input = test[FEATURE_COLUMNS].copy()
    ...
    training_features = preprocessor.transform(training_input)
    ...
    test_features = preprocessor.transform(test_input)
    ...
    print(f"training = {training_features.shape}, test = {test_features.shape}")
